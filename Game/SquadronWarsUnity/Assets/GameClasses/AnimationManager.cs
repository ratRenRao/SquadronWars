...
namespace Assets.GameClasses
{
    class AnimationManager
    {
        ...
        {
            int weaponId = 0;
            if (_executionerCharacterGameObject.CharacterClassObject.Equipment.Weapon1 != null)
                weaponId = _executionerCharacterGameObject.CharacterClassObject.Equipment.Weapon1.ItemId;
